...
const PaymentAttachmentsSchema = Joi.object({
...
const PaymentAttachmentsField = {
    ...
    All: ['id', 'payment_id', 'file', 'name', 'remarks', 'uploaded_by', 'uploaded_date'],
};


module.exports = {
  PaymentAttachmentsSchema,
  PaymentAttachmentsField, 
};
