                    ...
                    <div className="relative" ref={dropdownRef}>
                        ...
                        >
                            <div className="w-9 h-9 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-600 flex items-center justify-center text-white text-xs font-bold shadow-lg shadow-emerald-500/20 border-b-2 border-emerald-600">
                                {user?.mu_first_name?.charAt(0) || user?.fullname?.charAt(0) || 'A'}
                            </div>
                            ...
                            <ChevronDown size={14} className={`text-emerald-600 transition-transform ${showDropdown ? 'rotate-180' : ''}`} />
                        </button>
                        ...
                        <AnimatePresence>
                            {showDropdown && (
                                ...
                                >
                                    <button className="w-full flex items-center gap-3 px-4 py-3 text-sm text-gray-700 hover:bg-emerald-50 transition-colors">
