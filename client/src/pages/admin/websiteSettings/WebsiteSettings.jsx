...
import { Globe, Phone, Save, CheckCircle, Image, Mail, Hash, MapPin, Palette, Type } from 'lucide-react';
    ...
    if (loading) {
        return (
            <div className="h-full w-full flex flex-col items-center justify-center gap-4 bg-[#f4f5f7]">
                ...
                <p className="text-sm text-gray-500 font-medium">Synchronizing Website Settings...</p>
            </div>
        );
    }
            ...
            <ProtectedAction
                ...
                fallback={
                    <div className="flex flex-col items-center justify-center h-full text-center gap-3">
                        ...
                        <p className="text-sm text-gray-400">Please contact systems admin for Website Settings access.</p>
                    </div>
                }
            >
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-2 mt-1">
                                    ...
                                    <p className="text-xs text-gray-500 font-medium uppercase tracking-wider">Content Management & Branding</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="flex-1 bg-white border border-gray-200 rounded-2xl shadow-xl flex flex-col overflow-hidden">
                        ...
                        <div className="flex-1 overflow-y-auto p-5">
                            <div className="w-full grid grid-cols-12 gap-x-8 gap-y-10">
                                ...
                                {/* CENTER COLUMN: Hero Section Content */}
                                <div className="col-span-4 flex flex-col gap-6">
                                    ...
                                    <Field label="Welcome Badge">
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                onChange={(e) => handleInputChange('welcome_badge', e.target.value)}
                                    ...
                                    {/* Text Input Mode */}
                                    {backgroundInputMode === 'text' && (
                                        <Field label="Background Value (CSS Gradient)">
                                            <div className="relative">
                                                ...
                                                <textarea
                                                    ...
                                                    rows={3}
                                                    className={inputCls + ' pl-10 pt-3 resize-none'}
                                                    placeholder="CSS gradient (e.g., from-emerald-50 via-teal-50 to-cyan-50)"
                                                />
                                            </div>
                                        </Field>
                                    )}
                                                ...
                                                <div className="w-full aspect-video bg-white rounded-xl border border-gray-100 shadow-inner flex items-center justify-center overflow-hidden relative group">
                                                    {backgroundPreview ? (
                                                        ...
                                                        <div className="flex flex-col items-center gap-2 text-gray-300">
                                                            ...
                                                            <span className="text-[10px] uppercase font-bold tracking-widest">No Background Uploaded</span>
                                                        </div>
                                                    )}
                                                    <label className="absolute inset-0 bg-emerald-600/80 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center cursor-pointer">
                                                        ...
                                                        <span className="text-white text-xs font-bold uppercase tracking-tighter">Replace Background</span>
                                                    </label>
                                                </div>
                                                <p className="text-[10px] text-gray-400 text-center leading-relaxed px-4">
                                                    JPG, PNG, or GIF (Max 5MB). Recommended size: 1920x1080px.
                                                </p>
                                            </div>
                                        </Field>
                                    )}
                                ...
                                {/* RIGHT COLUMN: Visual Branding & Background */}
                                <div className="col-span-4 flex flex-col gap-6">
                                    ...
                                    <div className="p-4 bg-gray-50 border-2 border-dashed border-gray-200 rounded-2xl flex flex-col items-center gap-4">
                                        <div className="w-full aspect-video bg-white rounded-xl border border-gray-100 shadow-inner flex items-center justify-center overflow-hidden relative group">
                                            {logoPreview ? (
                                                <img src={logoPreview} alt="Website Logo" className="w-full h-full object-contain p-4" />
                                            ) : (
                                                <div className="flex flex-col items-center gap-2 text-gray-300">
                                                    <Image size={48} strokeWidth={1} />
                        ...
                        <div className="bg-gray-50 border-t border-gray-200 px-6 py-3 flex items-center justify-between flex-shrink-0">
                            <div className="flex items-center gap-4">
                                ...
                                <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">
                                    Version: <span className="text-gray-900 font-black">V1.0.0 WEBSITE SETTINGS</span>
                                </p>
                            </div>
                            <p className="text-[11px] font-black text-emerald-600 tracking-[2px] uppercase">CMO Connect</p>
                        </div>
                    </div>
                </motion.div>
            </ProtectedAction>
